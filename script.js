...
const firstPageY = firstPage.getBoundingClientRect().top + window.scrollY + -10;
const secondPageY = secondPage.getBoundingClientRect().top + window.scrollY + -10;
const thirdPageY = thirdPage.getBoundingClientRect().top + window.scrollY + -10;
const fourthPageY = fourthPage.getBoundingClientRect().top + window.scrollY + -10;
const fifthPageY = fifthPage.getBoundingClientRect().top + window.scrollY + -10;
const sixthPageY = sixthPage.getBoundingClientRect().top + window.scrollY + -10;
const seventhPageY = seventhPage.getBoundingClientRect().top + window.scrollY + -10;
const eightPageY = eightPage.getBoundingClientRect().top + window.scrollY + -10;
const ninthPageY = ninthPage.getBoundingClientRect().top + window.scrollY + -10;
const tenthPageY = tenthPage.getBoundingClientRect().top + window.scrollY + -10;
